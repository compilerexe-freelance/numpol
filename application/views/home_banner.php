<?php
$this->session->select_menu = "home_banner";
include('header.php');
...
?>
    ...
    <div class="container">
      ...
      <div class="col-md-12 form-group">
              <form method="POST" action="<?php echo base_url(); ?>index.php/main/db_home_banner" enctype="multipart/form-data">
                  <div class="form-group">
                      <span id="label_">Home Banner</span>
                  </div>
                  <div class="form-group">
